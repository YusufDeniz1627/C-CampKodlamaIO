...
namespace Core.Utilities.Security.Jwt
{
    public class JwtHelper : ITokenHelper
    {
        ...
        public AccessToken CreateToken(User user, List<OperationClaim> operationClaims)
        {
            ...
            var signignCredetails = SigningCredentailsHelper.CreateSigningCredetails(securityKey);
            var jwt = CreateJwtSecurityToken(_tokenOptions,user,signignCredetails,operationClaims);
